...
public class ToXamarin {
    ...
    public String xregister(@RequestParam(value="username") String username,
                           @RequestParam(value="password") String password,
                            @RequestParam(value="avatarNum") int avatarNum) {
        return String.valueOf(register(username, password, avatarNum));
    }
    ...
    public String xcreateTask(@RequestParam(value="myid") int myId,
                                       ...
                                       @RequestParam(value="taskicon") int icon){
        return String.valueOf(createTask(myId, taskName, repetition, frequency, members, date, bet, icon));
    }
